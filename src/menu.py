...
#this dictionary stores the functions that run the games
games = {
...
#this stores information for each game that displays before you run it
game_descriptions = {
...
def main_menu():
    ...
    #loop forever
    while True:
        #Have the user choose a game to play
        ...
        #if they chose to quit, break the loop
        if game == 'Quit':
            break
        #display the information for the game they chose along with a button to go back and a button to run the game
